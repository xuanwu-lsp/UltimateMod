...
public class ItemSpawnEntity303
  extends Item
{
  public ItemSpawnEntity303()
  {
    setTextureName("ultimate:egg");
    setUnlocalizedName("Spawn303");
  ...
  {
    return LudicrousText.makeFabulous("生成 Entity303");
  }
  
  public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float fx, float fy, float fz)
  {
	  if(!world.isRemote) {
		  Entity303 entity = new Entity303(world);
