...
public class UltimateLightningbolt extends Render
{
     ...
     */
    public void doRender(ultimateLightningbolt p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        for (int k1 = 0; k1 < 4; ++k1)
        {
            ...
            for (int j = 0; j < 3; ++j)
            {
                ...
                for (int i1 = k; i1 >= l; --i1)
                {
                    ...
                    float f2 = 0.5F;
                    tessellator.setColorRGBA_F(random.nextFloat(),random.nextFloat(),random.nextFloat(), 0.5F);
     ...
     */
    protected ResourceLocation getEntityTexture(ultimateLightningbolt p_110775_1_)
    {
        return null;
    }
    ...
    {
        return this.getEntityTexture((ultimateLightningbolt)p_110775_1_);
    }
    ...
    {
        this.doRender((ultimateLightningbolt)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}