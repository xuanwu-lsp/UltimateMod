...
public class GuiMain extends GuiMainMenu implements GuiYesNoCallback
{
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        String s2 = "The Ultimate Mod 0.41 Installed";
        this.drawString(this.fontRendererObj, s1, this.width - this.fontRendererObj.getStringWidth(s2) - 2, this.height - 8, -1);
