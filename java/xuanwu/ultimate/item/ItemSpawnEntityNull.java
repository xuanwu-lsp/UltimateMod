...
public class ItemSpawnEntityNull
  extends Item
{
  public ItemSpawnEntityNull()
  {
    setTextureName("ultimate:egg");
    setUnlocalizedName("SpawnNull");
  ...
  {
    return LudicrousText.makeFabulous("生成 Null");
  }
  
  public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float fx, float fy, float fz)
  {
	  if(!world.isRemote) {
		  EntityNull entity = new EntityNull(world);
