...
public class Entity303 extends EntityCreature implements IUltimateEntity{
	protected float Health = this.getMaxHealth();
	public Entity303(World p_i1602_1_) {
		super(p_i1602_1_);
        ...
        this.setCustomNameTag("Entity303");
	}
    ...
    {
		super.onUpdate();
		this.worldObj.setBlock((int)this.posX,(int)this.posY-1,(int)this.posZ,Blocks.bedrock);
    }
